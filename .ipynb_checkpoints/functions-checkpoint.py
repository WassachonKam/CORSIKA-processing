...
fp_RadE_norm2 = lambda primary, energy, sin2theta: f'radEnergy/norm_sintheta2/{primary}_{energy}_{sin2theta}.dat'
fp_Xmax = lambda primary, energy, sin2theta: f'Xmax/output/{primary}_{energy}_sin2_{sin2theta}.dat'
...
# def pltNeRadE_Xmax(primary, RadE):   
...
#     plt.xscale('log')
#     plt.yscale('log')
#     plt.title(rf'primary particle: {p}')